...
contract('TinyToken', function(accounts) {
  var tokenInstance;
  ...
  it('initializes the contract with the correct values', function() {
    return TinyToken.deployed().then(function(instance) {
      ...
      assert.equal(name, 'Tiny Token', 'has the correct name');
      return tokenInstance.symbol();
    }).then(function(symbol) {
      assert.equal(symbol, 'Tiny', 'has the correct symbol');
      return tokenInstance.standard();
    }).then(function(standard) {
      assert.equal(standard, 'Tiny Token v1.0', 'has the correct standard');
    });
  })
